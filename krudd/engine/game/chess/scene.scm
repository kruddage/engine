...
;;! chess's behalf. Their colours are this game's too: white wears
;;! project://material/chess-ivory and black project://material/chess-ebony, two
;;! (material ...) sources rules.scm registers through material-define! the same
;;! way. Knights face the enemy: the mesh faces +Z, so white's knights
