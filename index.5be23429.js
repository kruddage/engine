...
function game_launcher_add(name,idx) { var host = document.getElementById('launcher-games'); if (!host) return; var b = document.createElement('button'); b.className = 'launcher-btn'; b.id = 'launcher-game-' + idx; b.textContent = UTF8ToString(name); b.onclick = function () { Module._krudd_load_game(idx); }; host.appendChild(b); }
function game_launcher_rename(name,idx) { var b = document.getElementById('launcher-game-' + idx); if (b) b.textContent = UTF8ToString(name); }
...
var wasmImports = {
  ...
  game_launcher_hide,
  /** @export */
  game_launcher_rename,
  /** @export */
  game_show_load_prompt,
  /** @export */
