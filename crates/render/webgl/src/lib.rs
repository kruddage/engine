...
//! built with. That is #812's call: WebGL2 runs everywhere the engine ships,
//! which since #845 means browsers and nothing else, so deferring WebGPU costs
//! no reach and saves maintaining a fallback for it.
//!
