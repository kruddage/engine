...
((embed "mesh_script.scm" "mesh_script_scm.h" "MESH_SCRIPT_SCM")
 ...
 (library "asset_plugin"
   ...
   (public "include" (root "abi/include") (root "base/math/include") (root "world/entity/include"))
 ...
 (native-only
  ...
  (executable "mesh_script_test"
              ...
              (private "." "include" (root "abi/include") (root "base/math/include") (root "world/entity/include") (raw "../third_party"))
